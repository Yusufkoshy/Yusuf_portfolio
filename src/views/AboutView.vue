<template>
  <div class="about pb-40">
    <div class="pt-16 mx-9">
      <div>
        <h1 class="text-white text-5xl cursive mb-14">About Yusuf....</h1>
        <div
          class="about__explain border-solid border-cyan-700 border-2 rounded-lg p-2"
        >
          <span class="text-white cursive"
            >2000/03/10 is my date of birth since my childhood i had the passion
            of programming and coumputers and also technology and tech field in
            general and of course computer and video games when i was like 12 i
            was so curious about how websites are made i tried to research that
            and it was good for me understanding that i'm arabian but i'm
            bilingual so i was able to understand the content in English i
            ...
            communications and information Technology and information technology
            institute (iti) and Athar and itida but there's a test for the
